    ...
    return (
      <input
        ...
        className={cn(
          ...
          'flex h-[var(--height-44)] w-full rounded-8 border bg-input-background px-3 py-2 text-sm text-input-foreground outline-none transition-colors placeholder:text-input-foreground-placeholder disabled:cursor-not-allowed disabled:bg-input-background-disabled disabled:text-button-foreground-disabled',
          error
